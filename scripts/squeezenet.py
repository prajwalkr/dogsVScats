...
def SqueezeNet(nb_classes=1, inputs=(3, 224, 224)):
    ...
    conv1 = Convolution2D(
        96, 7, 7, activation='linear', init='glorot_uniform',
    ...
    fire2_squeeze = Convolution2D(
        16, 1, 1, activation='linear', init='glorot_uniform',
        border_mode='same', name='fire2_squeeze')(maxpool1)
    fire2_squeeze = ELU() (fire2_squeeze)
    fire2_expand1 = Convolution2D(
        64, 1, 1, activation='linear', init='glorot_uniform',
        border_mode='same', name='fire2_expand1')(fire2_squeeze)
    fire2_expand1 = ELU() (fire2_expand1)
    fire2_expand2 = Convolution2D(
        64, 3, 3, activation='linear', init='glorot_uniform',
        border_mode='same', name='fire2_expand2')(fire2_squeeze)
    fire2_expand2 = ELU() (fire2_expand2)
    merge2 = merge(
    ...
    fire3_squeeze = ELU() (fire3_squeeze)
    fire3_expand1 = Convolution2D(
        64, 1, 1, activation='linear', init='glorot_uniform',
        border_mode='same', name='fire3_expand1')(fire3_squeeze)
    fire3_expand1 = ELU() (fire3_expand1)
    fire3_expand2 = Convolution2D(
        64, 3, 3, activation='linear', init='glorot_uniform',
        border_mode='same', name='fire3_expand2')(fire3_squeeze)
    fire3_expand2 = ELU() (fire3_expand2)
    merge3 = merge(
        [fire3_expand1, fire3_expand2], mode='concat', concat_axis=1)

    fire4_squeeze = Convolution2D(
        32, 1, 1, activation='linear', init='glorot_uniform',
        border_mode='same', name='fire4_squeeze')(merge3)
    fire4_squeeze = ELU() (fire4_squeeze)
    fire4_expand1 = Convolution2D(
        128, 1, 1, activation='linear', init='glorot_uniform',
        border_mode='same', name='fire4_expand1')(fire4_squeeze)
    fire4_expand1 = ELU() (fire4_expand1)
    fire4_expand2 = Convolution2D(
        128, 3, 3, activation='linear', init='glorot_uniform',
        border_mode='same', name='fire4_expand2')(fire4_squeeze)
    fire4_expand2 = ELU() (fire4_expand2)
    merge4 = merge(
    ...
    fire5_squeeze = ELU() (fire5_squeeze)
    fire5_expand1 = Convolution2D(
        128, 1, 1, activation='linear', init='glorot_uniform',
        border_mode='same', name='fire5_expand1')(fire5_squeeze)
    fire5_expand1 = ELU() (fire5_expand1)
    fire5_expand2 = Convolution2D(
        128, 3, 3, activation='linear', init='glorot_uniform',
        border_mode='same', name='fire5_expand2')(fire5_squeeze)
    fire5_expand2 = ELU() (fire5_expand2)
    merge5 = merge(
        [fire5_expand1, fire5_expand2], mode='concat', concat_axis=1)

    fire6_squeeze = Convolution2D(
        48, 1, 1, activation='linear', init='glorot_uniform',
        border_mode='same', name='fire6_squeeze')(merge5)
    fire6_squeeze =  ELU() (fire6_squeeze)
    fire6_expand1 = Convolution2D(
        192, 1, 1, activation='linear', init='glorot_uniform',
        border_mode='same', name='fire6_expand1')(fire6_squeeze)
    fire6_expand1 = ELU() (fire6_expand1)
    fire6_expand2 = Convolution2D(
        192, 3, 3, activation='linear', init='glorot_uniform',
        border_mode='same', name='fire6_expand2')(fire6_squeeze)
    fire6_expand2 = ELU() (fire6_expand2)
    merge6 = merge(
    ...
    fire8_squeeze = ELU() (fire8_squeeze)
    fire8_expand1 = Convolution2D(
        256, 1, 1, activation='linear', init='glorot_uniform',
        border_mode='same', name='fire8_expand1')(fire8_squeeze)
    fire8_expand1 = ELU() (fire8_expand1)
    fire8_expand2 = Convolution2D(
        256, 3, 3, activation='linear', init='glorot_uniform',
        border_mode='same', name='fire8_expand2')(fire8_squeeze)
    fire8_expand2 = ELU() (fire8_expand2)
    merge8 = merge(
